...
const PointDetails: React.FC = () => {
  ...
  function handleComposeMail() {
    MailComposer.composeAsync({
      subject: "Repasse de material de coleta",
  ...
  function handleWhatsapp() {
    Linking.openURL(
      `whatsapp://send?phone=${pointDetails.point.whatsapp}&text=Repasse de material de coleta`
    );
  }
  ...
  // Install react-native-picker-select to pick the city and uf
